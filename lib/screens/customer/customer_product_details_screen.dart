...
class _CustomerProductDetailsScreenState extends ConsumerState<CustomerProductDetailsScreen> {
  ...
  Future<void> _addToCart(ProductModel product, {double? basePrice}) async {
    ...
    try {
      ...
      ref.read(cartProvider.notifier).addItemFromModel(cartItem);
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (surplus != null) ...[
                        const SizedBox(height: 8),
                        Text(
                          'Flash deal: ${surplus.quantity} left',
                          style: const TextStyle(
            ...
            child: SafeArea(
              child: ElevatedButton(
                onPressed: _isUploading
                    ? null
                    : () => _addToCart(product, basePrice: basePrice),
